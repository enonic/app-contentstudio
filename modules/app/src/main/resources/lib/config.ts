...
export function getConfig(locales: string[], aiEnabled: boolean, browseMode: boolean): Record<string, unknown> {
    ...
    return {
        ...
        services: {
            ...
            aiContentOperatorWsServiceUrl: serviceUrl({
                service: 'ws',
                application: 'com.enonic.app.ai.contentoperator',
                type: 'websocket',
            }),
            aiTranslatorLicenseServiceUrl: serviceUrl({
                service: 'license',
