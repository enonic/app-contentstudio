...
function modifyCollaborators(oldCollaborators, params, isJoin) {
    ...
    log.info('collaborators ' + JSON.stringify(collaborators));
    ...
    log.info('shouldPublishEvent ' + shouldPublishEvent);
...
function doJoinOrLeave(params, isJoin) {
    log.info((isJoin ? 'join' : 'leave') + ' ' + params.contentId + ':' + params.project + ' ' + params.userKey);
