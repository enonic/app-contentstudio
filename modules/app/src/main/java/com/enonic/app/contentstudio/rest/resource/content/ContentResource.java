...
import com.enonic.app.contentstudio.rest.resource.content.json.CompareContentsJson;
import com.enonic.app.contentstudio.rest.resource.content.json.ContentIdsJson;
import com.enonic.app.contentstudio.rest.resource.content.json.ContentIdsPermissionsJson;
import com.enonic.app.contentstudio.rest.resource.content.json.ContentPathsJson;
import com.enonic.app.contentstudio.rest.resource.content.json.ContentQueryJson;
import com.enonic.app.contentstudio.rest.resource.content.json.ContentSelectorQueryJson;
import com.enonic.app.contentstudio.rest.resource.content.json.ContentTreeSelectorJson;
import com.enonic.app.contentstudio.rest.resource.content.json.ContentTreeSelectorQueryJson;
import com.enonic.app.contentstudio.rest.resource.content.json.ContentWithRefsResultJson;
import com.enonic.app.contentstudio.rest.resource.content.json.CreateContentJson;
import com.enonic.app.contentstudio.rest.resource.content.json.CreateMediaFromUrlJson;
import com.enonic.app.contentstudio.rest.resource.content.json.DeleteAttachmentJson;
...
import com.enonic.app.contentstudio.rest.resource.content.json.EffectivePermissionAccessJson;
import com.enonic.app.contentstudio.rest.resource.content.json.EffectivePermissionJson;
import com.enonic.app.contentstudio.rest.resource.content.json.EffectivePermissionMemberJson;
import com.enonic.app.contentstudio.rest.resource.content.json.FindIdsByParentsResultJson;
import com.enonic.app.contentstudio.rest.resource.content.json.GetContentVersionsJson;
import com.enonic.app.contentstudio.rest.resource.content.json.GetDependenciesJson;
import com.enonic.app.contentstudio.rest.resource.content.json.GetDependenciesResultJson;
import com.enonic.app.contentstudio.rest.resource.content.json.GetDescendantsOfContents;
import com.enonic.app.contentstudio.rest.resource.content.json.HasUnpublishedChildrenResultJson;
import com.enonic.app.contentstudio.rest.resource.content.json.LocaleListJson;
...
import com.enonic.app.contentstudio.rest.resource.content.task.DuplicateRunnableTask;
    ...
    implements JaxRsComponent
{
    ...
    @POST
    @Path("updateMetadata")
    public ContentJson updateMetadata( final UpdateContentMetadataJson json, @Context HttpServletRequest request )
    {
    ...
    {
        final GetContentVersionsParams findParam = GetContentVersionsParams.create().contentId( ContentId.from( id ) ).size( 1 ).build();
    ...
    private ContentVersion getActiveVersion( final GetContentVersionsParams findParam )
    {
