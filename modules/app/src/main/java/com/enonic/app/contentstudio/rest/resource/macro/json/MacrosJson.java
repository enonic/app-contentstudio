...
import com.enonic.app.contentstudio.rest.resource.macro.MacroIconUrlResolver;
...
public class MacrosJson
{
    ...
    {
        return notSortedMacros.stream()
            .sorted( Comparator.comparing( MacroDescriptorJson::getDisplayName ) )
