...
import {ExtensionItemView} from '../view/context/ExtensionItemView';
...
export class ExtensionPermissionsItemView
    ...
    constructor() {
        super('extension-permissions-item-view');
    ...
    public setContentAndUpdateView(item: ContentSummaryAndCompareStatus): Q.Promise<void> {
        ...
        if (ExtensionPermissionsItemView.debug) {
            console.debug('ExtensionPermissionsItemView.setContentId: ', contentId);
        }
    ...
    private layoutHeader(content: Content) {
        ...
        this.headerEl = new DivEl('extension-permissions-header');
    ...
    public layout(): Q.Promise<void> {
        if (ExtensionPermissionsItemView.debug) {
            console.debug('ExtensionPermissionsItemView.layout');
        }
