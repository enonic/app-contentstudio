...
export class ExtensionDependencyItemView
    ...
    private readonly inboundButton: ActionButton;
    private readonly outboundButton: ActionButton;

    constructor() {
        super('extension-dependency-item-view');
    ...
    public setContentAndUpdateView(item: ContentSummaryAndCompareStatus): Q.Promise<void> {
        if (ExtensionDependencyItemView.debug) {
