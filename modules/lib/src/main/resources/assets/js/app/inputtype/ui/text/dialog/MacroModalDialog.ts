...
export class MacroModalDialog
    ...
    private sanitize(value: string): string {
        ...
        return DOMPurify.sanitize(value, {ALLOW_UNKNOWN_PROTOCOLS: true, ALLOWED_URI_REGEXP: this.getAllowedUriRegexp()});
    }
    ...
    private getAllowedUriRegexp(): RegExp {
        return /^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp|xxx|content):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i;
    }
