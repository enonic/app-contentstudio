...
export class PageEventsManager {
    ...
    onComponentViewDragDropped(listener: ((event: ComponentViewDragDroppedEvent) => void)): void {
        this.componentViewDragDroppedListeners.push(listener);
    }

    unComponentViewDragDropped(listener: ((event: ComponentViewDragDroppedEvent) => void)): void {
    ...
    onComponentSelectRequested(listener: ((path: ComponentPath) => void)): void {
        this.componentSelectRequestedListeners.push(listener);
    }

    unComponentSelectRequested(listener: ((path: ComponentPath) => void)): void {
    ...
    onComponentInspectRequested(listener: ((component: Component) => void)): void {
        this.componentInspectRequestedListeners.push(listener);
    }

    unComponentInspectRequested(listener: ((component: Component) => void)): void {
    ...
    onComponentInsertRequested(listener: ((parentPath: ComponentPath, type: ComponentType) => void)): void {
        this.componentInsertRequestedListeners.push(listener);
    }

    unComponentInsertRequested(listener: ((parentPath: ComponentPath, type: ComponentType) => void)): void {
