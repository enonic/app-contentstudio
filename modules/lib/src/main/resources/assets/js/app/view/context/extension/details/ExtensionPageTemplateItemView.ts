...
import {DefaultModelsFactory, type DefaultModelsFactoryConfig} from '../../../../wizard/page/DefaultModelsFactory';
...
export class ExtensionPageTemplateItemView
    ...
    constructor() {
        super('extension-page-template-item-view');
    }
    ...
    public layout(): Q.Promise<void> {
        if (ExtensionPageTemplateItemView.debug) {
