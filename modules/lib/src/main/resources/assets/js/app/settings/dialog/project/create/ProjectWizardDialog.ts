...
export class ProjectWizardDialog
    ...
    protected displayStep(step: ProjectDialogStep) {
        ...
        if (this.isNameAutoGenerated && this.isProjectIdStep()) {
            ...
            (this.currentStep as ProjectLocaleDialogStep).setParentProject(this.getParentProject());
        } else if (this.isAccessDialogStep()) {
            (this.currentStep as ProjectAccessDialogStep).setParentProject(this.getParentProject());
        } else if (this.isPermissionsStep()) {
            (this.currentStep as ProjectPermissionsDialogStep).setParentProject(this.getParentProject());
