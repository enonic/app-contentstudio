...
export class ProjectWizardDialog
    ...
    protected displayStep(step: ProjectDialogStep) {
        ...
        } else if (this.config.parentProjects && this.isParentProjectStep()) {
            this.setParentProjects();
        } else if (this.currentStep instanceof ProjectDialogStep) {
    ...
    private setParentProjects(): void {
        (this.currentStep as ProjectTypeDialogStep).setSelectedProjects(this.config.parentProjects);
