...
export class ProjectWizardDialog
    ...
    protected displayStep(step: ProjectDialogStep) {
        ...
        if (this.currentStep instanceof ProjectIdDialogStep && this.isNameAutoGenerated) {
            this.setNameFromParentProjects();
        } else if (this.currentStep instanceof ProjectLocaleDialogStep ||
                    this.currentStep instanceof ProjectAccessDialogStep ||
                    this.currentStep instanceof ProjectPermissionsDialogStep) {
            this.currentStep.setParentProjects(this.getParentProjects());
        } else if (this.currentStep instanceof ProjectSummaryStep) {
    ...
    private produceCreateItemRequest(): ProjectCreateRequest {
        ...
        return <ProjectCreateRequest>new ProjectCreateRequest()
            .setParents(this.getParentProjects()?.map(p => p.getName()))
