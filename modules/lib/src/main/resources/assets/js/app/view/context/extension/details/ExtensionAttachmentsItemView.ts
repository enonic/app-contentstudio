...
export class ExtensionAttachmentsItemView extends ExtensionItemView {
    ...
    constructor() {
        super('extension-attachments-item-view');

        this.contentRootPath = ContentPath.CONTENT_ROOT;
    }

    setContentRootPath(value: string): ExtensionAttachmentsItemView {
    ...
    public setContentAndUpdateView(item: ContentSummaryAndCompareStatus): Q.Promise<void> {
        ...
        if (ExtensionAttachmentsItemView.debug) {
            ...
            (attachments: Attachments) => {
                ...
                if (attachments) {
                    ...
                    attachments.forEach((attachment: Attachment) => {
                        ...
                        const link = ExtensionAttachmentsItemView.createLinkEl(contentId, attachment.getName(), this.contentRootPath);
