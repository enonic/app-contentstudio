...
export class RegionInspectionPanel extends BaseInspectionPanel {
    ...
    constructor() {
        ...
        this.namesAndIcon = new NamesAndIconView(
            new NamesAndIconViewBuilder().setSize(NamesAndIconViewSize.medium),
        ).setIconClass(ItemViewIconClassResolver.resolveByType('region'));
    ...
    setRegion(region: Region) {
        if (region) {
            this.namesAndIcon.setMainName(capitalize(region.getName()));
