...
const getHiddenFormattingState = (
    editorParams: HtmlEditorParams,
): Pick<FullscreenDialogStore, 'hideBold' | 'hideItalic' | 'hideUnderline'> => {
...
export const initializeFullscreenDialogEditor = (): void => {
    ...
    HtmlEditor.create(fullscreenEditorParams)
        .then((fullscreenEditor: HtmlEditor) => {
