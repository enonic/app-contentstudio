    ...
    return (
        <Dialog.Root data-component={NEW_CONTENT_DIALOG_NAME} open={open} onOpenChange={handleOpenChange}>
            <Dialog.Portal>
                ...
                >
                    <Dialog.Header
                        className={cn('flex justify-between transition-[blur] duration-500', isDragging && 'blur-xs')}
                    >
                    ...
                    <Dialog.Body className="overflow-visible">
                        ...
                        >
                            <Tab.List className={cn('transition-[blur] duration-500', isDragging && 'blur-xs')}>
