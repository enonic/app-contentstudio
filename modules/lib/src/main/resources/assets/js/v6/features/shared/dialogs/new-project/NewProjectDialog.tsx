...
import {$newProjectDialog, closeNewProjectDialog} from '../../../store/dialogs/newProjectDialog.store';
...
export const NewProjectDialog = (): ReactElement => {
    ...
    return (
        <Dialog.Root defaultStep={'step-parent'} data-component={NEW_PROJECT_DIALOG_NAME} open={open} onOpenChange={handleOpenChange}>
            <Dialog.Portal>
                <Dialog.Overlay />
