...
import { EditPropertiesDialog } from '../../../../features/edit-properties/ui/EditPropertiesDialog';
import { $contextContent } from '../../model/contextContent.store';
import {
    closeEditPropertiesDialog,
    openEditPropertiesDialog,
} from '../../../../features/edit-properties/model/editPropertiesDialog.store';
...
export const DetailsWidgetInfoSection = (): ReactElement => {
    const helper = useMemo(() => new ExtensionBasePropertiesItemViewHelper(), []);
