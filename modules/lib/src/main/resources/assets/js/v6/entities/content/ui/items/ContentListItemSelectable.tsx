...
export const ContentListItemSelectable = ({
    ...
    return (
        <ListItem
            ...
            {...props}
        >
            <ListItem.Left className={cn(layout === 'mobile-status-below' && 'max-sm:col-start-1 max-sm:row-start-1')}>
                <Checkbox
                    id={checkboxId}
                    checked={checked}
            ...
            <ListItem.Content
                className={cn('flex', layout === 'mobile-status-below' && 'max-sm:col-start-2 max-sm:row-start-1')}
            >
                <Button
                    onClick={handleClick}
                    tabIndex={tabIndex}
