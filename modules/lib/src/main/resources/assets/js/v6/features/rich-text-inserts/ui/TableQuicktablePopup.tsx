...
import { clamp } from '../../../shared/lib/ckeditor/ckeditorDialogUtils';
import { useCkEditorFocusManager } from '../../../shared/lib/ckeditor/useCkEditorFocusManager';
import { usePopupDismiss } from '../../../shared/lib/ckeditor/usePopupDismiss';
import { usePopupPosition } from '../../../shared/lib/ckeditor/usePopupPosition';
import {
...
} from '../model/tableQuicktablePopup.store';
...
export const TableQuicktablePopup = (): ReactElement | null => {
    ...
    useCkEditorFocusManager(editor, [popupRef, moreButtonRef, ...cellRefs.current], [open, cellCount]);
