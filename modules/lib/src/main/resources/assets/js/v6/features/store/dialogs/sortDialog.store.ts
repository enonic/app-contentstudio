...
export const $sortDialogSelection = computed($sortDialog, ({selectedOptionId}) => SORT_OPTION_MAP[selectedOptionId]);
...
export const setSortDialogManualChanges = (changed: boolean): void => {
    $sortDialog.setKey('hasManualChanges', changed);
};
