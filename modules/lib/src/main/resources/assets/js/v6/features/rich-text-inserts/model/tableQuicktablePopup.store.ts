...
export const openTableQuicktablePopup = ({ editor }: TableQuicktablePopupParams): void => {
    ...
    $tableQuicktablePopup.set({
        ...
        previewSize:
            getOptionalStringConfig(editor.config['qtPreviewSize'], DEFAULT_PREVIEW_SIZE) ?? DEFAULT_PREVIEW_SIZE,
        previewBorder:
            getOptionalStringConfig(editor.config['qtPreviewBorder'], DEFAULT_PREVIEW_BORDER) ?? DEFAULT_PREVIEW_BORDER,
        previewBackground:
            getOptionalStringConfig(editor.config['qtPreviewBackground'], DEFAULT_PREVIEW_BACKGROUND) ??
