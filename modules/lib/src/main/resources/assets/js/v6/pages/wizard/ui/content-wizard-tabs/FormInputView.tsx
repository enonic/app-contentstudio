...
import { getInputPath, toPathKey } from '../../../../shared/lib/cms/property/path';
...
const REPEATABLE_BASIC_INPUT_TYPES = new Set<string>(['TextLine', 'TextArea']);
...
export const FormInputView = ({ input, parentPath }: FormInputViewProps): ReactElement => {
    ...
    return (
        <div className="flex flex-col gap-2">
            {inputLabel && <span className="text-base font-semibold">{inputLabel}</span>}
