...
} from '../model/duplicateDialog.store';
import { ContentListItem } from '../../../entities/content/ui/items';
import { ContentListItemWithChildren } from '../../../entities/content/ui/items';
...
export const DuplicateDialogMainContent = ({
    ...
    return (
        <Dialog.Content
            className="w-full gap-5 md:gap-10 p-5 md:p-10 h-full max-sm:max-h-none sm:h-fit md:min-w-180 md:max-w-184 md:max-h-[85vh] lg:max-w-220"
