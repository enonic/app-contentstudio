...
} from '../../../shared/lib/ckeditor/ckeditorDialogUtils';
...
export const isTableDialogSubmittable = (mode: TableDialogMode, rows: string, cols: string): boolean => {
    return (
        mode === 'tableProperties' ||
...
const getDialogValue = (dialog: CKEDITOR.dialog, pageId: string, elementId: string): string => {
    return getDialogElement(dialog, pageId, elementId).getValue();
};

const setDialogValue = (dialog: CKEDITOR.dialog, pageId: string, elementId: string, value: string): void => {
...
const getTableDialogNumericFieldValue = (state: TableDialogStore, field: TableDialogNumericField): string => {
...
const setTableDialogNumericField = (field: TableDialogNumericField, value: string): void => {
    ...
    $tableDialog.set({
        ...
        validationErrors: {
            ...
            [field]: state.validationErrors[field]
                ? getTableDialogNumericFieldError(nextState, field)
