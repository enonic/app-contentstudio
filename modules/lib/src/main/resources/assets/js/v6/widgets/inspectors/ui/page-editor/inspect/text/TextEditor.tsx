...
import { createAnchorDialogOverride } from '../../../../../../features/rich-text-inserts/ui/AnchorDialog';
import { createBulletedListDialogOverride } from '../../../../../../features/rich-text-inserts/ui/BulletedListDialog';
import { createCodeDialogOverride } from '../../../../../../features/rich-text-inserts/ui/CodeDialog';
import { createFullscreenDialogOverride } from '../../../../../../features/rich-text-inserts/ui/FullscreenDialog';
import { HtmlAreaDialogs } from '../../../../../../features/rich-text-inserts/ui/HtmlAreaDialogs';
import { createNumberedListDialogOverride } from '../../../../../../features/rich-text-inserts/ui/NumberedListDialog';
import { createSearchPopupOverride } from '../../../../../../features/rich-text-inserts/ui/SearchPopup';
import { createSpecialCharDialogOverride } from '../../../../../../features/rich-text-inserts/ui/SpecialCharDialog';
import { createTableDialogOverride } from '../../../../../../features/rich-text-inserts/ui/TableDialog';
import { createTableQuicktablePopupOverride } from '../../../../../../features/rich-text-inserts/ui/TableQuicktablePopup';
import {
    createImageDialogOverride,
    HtmlAreaImageDialog,
} from '../../../../../../features/rich-text-inserts/ui/htmlarea-image/HtmlAreaImageDialog';
import type { OpenHtmlAreaImageDialogParams } from '../../../../../../features/rich-text-inserts/ui/htmlarea-image/HtmlAreaImageDialogContext';
import {
    createLinkDialogOverride,
    HtmlAreaLinkDialog,
} from '../../../../../../features/rich-text-inserts/ui/htmlarea-link/HtmlAreaLinkDialog';
import type { OpenHtmlAreaLinkDialogParams } from '../../../../../../features/rich-text-inserts/ui/htmlarea-link/HtmlAreaLinkDialogContext';
import {
...
} from '../../../../../../features/shared/form/input-types/html-area/setupEditor';
import { useCKEditorConfig } from '../../../../../../features/shared/form/input-types/html-area/useCKEditorConfig';
