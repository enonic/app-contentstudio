...
} from '../model/unpublishDialog.store';
...
export const UnpublishDialogMainContent = ({
    ...
    return (
        <Dialog.Content
            className="w-full h-full max-sm:max-h-none sm:h-fit gap-2.5 md:gap-10 p-5 md:p-10 md:min-w-180 md:max-w-184 md:max-h-[85vh] lg:max-w-220"
