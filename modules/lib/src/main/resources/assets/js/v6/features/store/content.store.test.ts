...
describe('content.store', () => {
    ...
    describe('socket subscriptions', () => {
        ...
        it('prevents double subscription', () => {
            const unsub1 = subscribeToContentEvents();
            const unsub2 = subscribeToContentEvents();

            // Both return unsubscribe functions
            // Second call returns early since already subscribed
