...
export const DateTimeSelector = ({
    ...
    useEffect(() => {
        if (rootRef.current) {
            setInternalPortalContainer(rootRef.current);
        }
    }, []);
    ...
    const resolvedPortalContainer = portalContainer ?? internalPortalContainer;
    ...
    return (
        ...
        >
            ...
            >
                ...
                />
                <DatePicker.Portal container={resolvedPortalContainer}>
                    <DatePicker.Content
                        ref={contentRef}
                        className='max-w-90'
                        align='end'
