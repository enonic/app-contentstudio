    ...
    implements JaxRsComponent
{
    ...
    public PageDescriptorJson getByKey( @QueryParam("key") final String pageDescriptorKey, @Context HttpServletRequest request )
    {
        ...
        final CmsFormFragmentResolver resolver = new CmsFormFragmentResolver( this.cmsFormFragmentService );
        final PageDescriptorJson json = new PageDescriptorJson( descriptor, localeMessageResolver, resolver );
        return json;
    }
