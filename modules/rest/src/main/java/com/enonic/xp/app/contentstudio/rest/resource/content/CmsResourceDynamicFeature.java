...
import com.enonic.xp.app.contentstudio.rest.resource.macro.MacroResource;
...
import com.enonic.xp.app.contentstudio.rest.resource.schema.mixin.MixinContextResource;
    ...
    implements DynamicFeature, JaxRsComponent
{
    private final Set<Class<? extends JaxRsComponent>> supportedResources =
        Set.of( ContentResource.class, ContentImageResource.class, ContentIconResource.class, ContentMediaResource.class,
                ...
                PageTemplateResource.class, FragmentResource.class, MixinContextResource.class,
