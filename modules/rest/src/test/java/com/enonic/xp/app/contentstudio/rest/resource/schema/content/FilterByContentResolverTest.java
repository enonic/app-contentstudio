...
class FilterByContentResolverTest
{
    ...
    {
        when( projectService.getAvailableApplications( ProjectName.from("default") ) ).thenReturn( ApplicationKeys.empty() );
    ...
    void contentTypes_root_with_apps()
    {
        ...
        when( projectService.getAvailableApplications( ProjectName.from("default") ) ).thenReturn( ApplicationKeys.from("app1") );
