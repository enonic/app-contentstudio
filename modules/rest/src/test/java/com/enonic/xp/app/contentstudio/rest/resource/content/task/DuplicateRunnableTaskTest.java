...
import com.enonic.xp.app.contentstudio.rest.resource.content.json.DuplicateContentJson;
    ...
    extends AbstractRunnableTaskTest
{
        ...
        throws Exception
    {
        ...
        final Content child4 = Content.create()
            .id( ContentId.from( "id4" ) )
            .path( ContentPath.from( contents.get( 0 ).getPath(), "content4" ) )
            .name( "content4" )
            .displayName( "Content 4" )
            .build();
        final Content child5 = Content.create()
            .id( ContentId.from( "id5" ) )
            .path( ContentPath.from( child4.getPath(), "content5" ) )
            .name( "content5" )
