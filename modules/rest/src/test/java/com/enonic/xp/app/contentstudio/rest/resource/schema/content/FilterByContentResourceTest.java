    ...
    extends AdminResourceTestSupport
{
        ...
        throws Exception
    {
        ...
        String jsonString =
            request().path( "cms/default/schema/filter/contentTypes" ).queryParam( "contentId", "test" ).get().getAsString();
        ...
        throws Exception
    {
        ...
        String jsonString = request().path( "cms/default/schema/filter/contentTypes" ).get().getAsString();
        ...
        throws Exception
    {
        ...
        String jsonString =
            request().path( "cms/default/schema/filter/layouts" ).queryParam( "contentId", "test" ).get().getAsString();
        ...
        throws Exception
    {
        ...
        String jsonString = request().path( "cms/default/schema/filter/parts" ).queryParam( "contentId", "test" ).get().getAsString();
        ...
        throws Exception
    {
        ...
        String jsonString = request().path( "cms/default/schema/filter/pages" ).queryParam( "contentId", "test" ).get().getAsString();
