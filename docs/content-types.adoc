...
<content-type>
  ...
  <config>  <!--1-->
    <allow-new-content>true</allow-new-content>  <!--2-->
...
<2> *allow-new-content* (default: `false`) When set to `true`, removes the content type from the "New Content" modal dialog.
