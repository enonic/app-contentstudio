...
image::../../editor/images/wizard-component-view-collapsed.png[Page Components view - Docked, 75%]
image::../../editor/images/wizard-component-view-floating.png[Page Components view - Floating, 75%]
