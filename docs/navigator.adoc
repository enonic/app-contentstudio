...
image::navigator-search.png[Search and filtering, 1094w]
...
image::navigator-search-expanded.png[Full content type list, 1080w]
...
image::navigator-search-modifier-expanded.png[Listing all modifiers, 1089w]
