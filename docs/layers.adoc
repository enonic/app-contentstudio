...
NOTE: The https://market.enonic.com/vendors/enonic/juke-ai-content-translator[Juke AI translator] application must be installed to access the features described in this section
