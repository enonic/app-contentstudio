...
describe('double.content.config.spec:  verifies `Min/max value config for Double`', function () {
    ...
    // TODO bug
    it.skip(`GIVEN wizard for 'Double(default value is 3)' is opened WHEN 'Add' button has been pressed AND the top input has been removed THEN validation message should not be displayed`,
        async () => {
