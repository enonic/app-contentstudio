...
describe('Tests for dependent items in Unpublish dialog (for scheduled content)', function () {
    ...
    it(`WHEN existing site(include child items) has been scheduled THEN PUBLISHING SCHEDULED status should be displayed in the grid`, async () => {
        ...
        assert.equal(
            actualStatus,
            appConst.CONTENT_STATUS.SCHEDULED,
            'Scheduled status should be displayed in the grid',
        );
    ...
    it(`GIVEN existing scheduled site is selected WHEN Unpublish menu item has been clicked THEN 'Show dependent items' link should be displayed in the modal dialog`, async () => {
        ...
        assert.equal(
            actualStatus,
            appConst.CONTENT_STATUS.SCHEDULED,
            'Scheduled status should be displayed in the dialog',
        );
    ...
    it.skip(`GIVEN existing scheduled site has been modified WHEN 'Publish' menu has been has been clicked THEN 'Update Scheduled' button should be displayed in the Publish Dialog`, async () => {
        ...
        assert.strictEqual(
            actualStatus,
            appConst.CONTENT_STATUS.SCHEDULED_MODIFIED,
