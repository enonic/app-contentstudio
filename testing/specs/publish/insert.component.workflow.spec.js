...
describe("insert.component.workflow.spec - insert a component and click on 'Mark as ready button'", function () {
    ...
    it("GIVEN a text component has been inserted in the site WHEN 'Mark as ready' button has been pressed THEN site's status gets 'Ready for publishing'", async () => {
    ...
    it("GIVEN text with spaces has been inserted in the text component WHEN 'Save' button has been pressed THEN 'Saved' button should appear in the wizard toolbar", async () => {
        let pageComponentView = new PageComponentView();
        let textComponentInspectionPanel = new TextComponentInspectionPanel();
        let contentWizard = new ContentWizard();
