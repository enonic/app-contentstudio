...
describe('project.wizard.dialog.name.step.spec - ui-tests for Name/Id wizard step', function () {
    ...
    it(`GIVEN navigated to Name/Id wizard step WHEN identifier and display name inputs are empty THEN 'This field is required' should be displayed`, async () => {
    ...
    it(`GIVEN navigated to Name/Id wizard step WHEN identifier input has been cleared THEN 'This field is required' should be displayed`, async () => {
        let settingsBrowsePanel = new SettingsBrowsePanel();
        let nameIdStep = new ProjectWizardDialogNameAndIdStep();
        // 1.Open new project wizard:
        await settingsBrowsePanel.openProjectWizardDialog();
