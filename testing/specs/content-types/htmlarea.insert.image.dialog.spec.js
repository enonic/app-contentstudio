...
describe('htmlarea.insert.image.dialog.spec: open insert image dialog.', function () {
    ...
    it(`GIVEN Align Center button has been pressed in the Insert Image dialog WHEN 'Insert' button has been opened THEN expected styles for the image should be applied in html-area`, async () => {
    ...
    it(`GIVEN an image with a caption is inserted in htmlarea WHEN Update image dialog has been opened and the caption has been updated THEN Save button gets enabled after closing the modal dialog`, async () => {
        let contentWizard = new ContentWizard();
        let htmlAreaForm = new HtmlAreaForm();
        let insertImageDialog = new InsertImageDialog();
        await studioUtils.selectSiteAndOpenNewWizard(IMPORTED_SITE_NAME, appConst.contentTypes.HTML_AREA_0_1);
    ...
    it(`GIVEN 'Insert Image' dialog is opened WHEN ESC key has been pressed THEN dialog should be closed`, async () => {
        let contentWizard = new ContentWizard();
        let htmlAreaForm = new HtmlAreaForm();
        let insertImageDialog = new InsertImageDialog();
        await studioUtils.selectSiteAndOpenNewWizard(IMPORTED_SITE_NAME, appConst.contentTypes.HTML_AREA_0_1);
    ...
    it(`GIVEN 'Insert Image' dialog is opened WHEN 'Cancel' button has been clicked THEN dialog should be closed`, async () => {
        let htmlAreaForm = new HtmlAreaForm();
        let insertImageDialog = new InsertImageDialog();
        await studioUtils.selectSiteAndOpenNewWizard(IMPORTED_SITE_NAME, appConst.contentTypes.HTML_AREA_0_1);
        await htmlAreaForm.showToolbarAndClickOnInsertImageButton();
    ...
    it(`GIVEN 'Insert Image' dialog is opened WHEN both radio buttons should not be selected`, async () => {
        let htmlAreaForm = new HtmlAreaForm();
        let insertImageDialog = new InsertImageDialog();
    ...
    it(`GIVEN 'Insert Image' dialog is opened WHEN 'DecorativeImage' radio button has been selected THEN the AccessibilityForm remains valid`, async () => {
        let htmlAreaForm = new HtmlAreaForm();
        let insertImageDialog = new InsertImageDialog();
        await studioUtils.selectSiteAndOpenNewWizard(IMPORTED_SITE_NAME, appConst.contentTypes.HTML_AREA_0_1);
        // 1. Open Insert Image dialog:
    ...
    it(`GIVEN 'Insert Image' dialog is opened WHEN 'Alternative Text' radio button has been clicked THEN Insert button gets enabled`, async () => {
        let htmlAreaForm = new HtmlAreaForm();
        let insertImageDialog = new InsertImageDialog();
        await studioUtils.selectSiteAndOpenNewWizard(IMPORTED_SITE_NAME, appConst.contentTypes.HTML_AREA_0_1);
        // 1. Open Insert Image dialog:
    ...
    it(`GIVEN an image with 'Alternative Text' WHEN Update Image dialog has been opened THEN expected alt-text should be displayed in the form`, async () => {
        let htmlAreaForm = new HtmlAreaForm();
        let insertImageDialog = new InsertImageDialog();
        await studioUtils.selectSiteAndOpenNewWizard(IMPORTED_SITE_NAME, appConst.contentTypes.HTML_AREA_0_1);
        // 1. Open Insert Image dialog:
    ...
    it(`GIVEN text has been inserted in 'Alternative Text' input WHEN the image has been replaced in the dialog THEN 'Alternative Text' input should be cleared`, async () => {
        let htmlAreaForm = new HtmlAreaForm();
        let insertImageDialog = new InsertImageDialog();
        await studioUtils.selectSiteAndOpenNewWizard(IMPORTED_SITE_NAME, appConst.contentTypes.HTML_AREA_0_1);
        // 1. Open Insert Image dialog:
    ...
    it(`GIVEN image binary has alt text WHEN Insert image dialog opened THEN expected 'alternative text' should be loaded in the modal dialog`, async () => {
        let htmlAreaForm = new HtmlAreaForm();
        let insertImageDialog = new InsertImageDialog();
        await studioUtils.selectSiteAndOpenNewWizard(IMPORTED_SITE_NAME, appConst.contentTypes.HTML_AREA_0_1);
        // 1. Open Insert Image dialog:
        ...
        // 4. 'Alternative text' radio-button should be pre-selected, because the alt-text is not empty:
        let isSelected = await insertImageDialog.isAlternativeTextRadioSelected();
        assert.ok(isSelected === true, `'Alternative text' radio-button should be selected`);
    });
