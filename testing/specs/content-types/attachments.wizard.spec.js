...
describe('attachments.wizard.spec: tests attachments content', function () {
    ...
    it("WHEN new wizard required 'attachment' is opened THEN Attachment-uploader with 'Upload' button should be displayed",
        async () => {
    ...
    it("GIVEN existing attachment(1:1) has been reopened WHEN attachment binary is not uploaded THEN the content should be not valid",
        async () => {
            ...
            let actualRecording = await attachmentsForm.getOccurrenceValidationRecording(0);
