...
describe('custom.selector.0_2.spec:  tests for content with custom selector (0:2)', function () {
    ...
    await
    customSelectorForm.selectOption(OPTION_2);
    await
    contentWizard.waitAndClickOnSave();
    ...
    await
    customSelectorForm.swapOptions(OPTION_2, OPTION_1);
    let options = await
    customSelectorForm.getSelectedOptions()
