...
describe('page.template.controller.support.spec tests for page template wizard', function () {
    ...
    it("GIVEN a controller has been selected in template-wizard WHEN an option has been selected in support dropdown selector THEN 'Save' button gets enabled", async () => {
    ...
    // Verifies the bug https://github.com/enonic/app-contentstudio/issues/10782
    it("GIVEN existing template is opened WHEN 'Mark as ready' menu item has been pressed THEN 'Content is ready for publishing' appears in the modal dialog", async () => {
        let contentWizard = new ContentWizard();
