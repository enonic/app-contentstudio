...
describe('Generate name for fragments specification', function () {
    ...
    it(`GIVEN an image is inserted in text-component WHEN the component has been saved as fragment THEN expected fragment-name should be generated`, async () => {
    ...
    it(`WHEN a fragment-text with an image has been selected AND Show Inbound button has been pressed THEN the parent site should be filtered in the grid`, async () => {
    ...
    it(`WHEN the site has been expanded THEN the expected fragment name should be displayed beneath the site-name`, async () => {
        let contentFilterPanel = new ContentFilterPanel();
        let contentBrowsePanel = new ContentBrowsePanel();
        ...
        assert.ok(
            result[1].includes(FRAGMENT_GENERATED_NAME),
            'expected fragment name should be displayed in the grid',
        );
    });

    it(`WHEN a fragment-text has been clicked in Page Component View and 'Remove' menu item has been selected THEN the fragment should be removed in the Page Component View`, async () => {
        let pageComponentView = new PageComponentView();
        let contentWizard = new ContentWizard();
    ...
    it(`WHEN existing fragment-text has been inserted in site THEN the site should be automatically saved`, async () => {
        let pageComponentView = new PageComponentView();
        let contentWizard = new ContentWizard();
    ...
    it.skip(`GIVEN an image has been inserted in new text-component WHEN 'Mark as ready' button has been pressed THEN Ready for publishing state should be displayed in the wizard`, async () => {
        let contentWizard = new ContentWizard();
        let textComponentInspectionPanel = new TextComponentInspectionPanel();
        let pageComponentView = new PageComponentView();
        let insertImageDialog = new InsertImageDialog();
