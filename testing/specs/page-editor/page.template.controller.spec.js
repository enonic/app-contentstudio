...
describe('page.template.controller: select a controller in a template-wizard', function () {
    ...
    it(`GIVEN _templates folder is selected WHEN New button has been pressed THEN Media tab item should be disabled in the modal dialog`,
        async () => {
    ...
    it(`GIVEN site is opened and 'Customise page' button has been clicked WHEN new text component with a text has been inserted THEN the expected text should be displayed in the Live Edit`,
        async () => {
            let contentWizard = new ContentWizard();
            let pageInspectionPanel = new PageInspectionPanel();
            let liveFormPanel = new LiveFormPanel();
