...
describe('insert.part.htmlarea.spec - insert a html-part in htlmlarea-content', function () {
    ...
    it(`GIVEN a part with html-example has been inserted WHEN text has been typed in the html-area THEN the text should appear in the Page Editor`, async () => {
    ...
    it(`GIVEN existing content with part(custom icon) is opened WHEN the part has been duplicated THEN the duplicated part should displayed with custom icon`, async () => {
        let contentWizard = new ContentWizard();
    ...
    it(`WHEN existing content with 2 parts(custom icon) is opened THEN both parts should displayed with custom icon`, async () => {
        let contentWizard = new ContentWizard();
        let pageComponentView = new PageComponentView();
        // 1. Open the content:
        await studioUtils.selectAndOpenContentInWizard(CONTENT_NAME);
    ...
    it(`GIVEN existing content is opened WHEN part with custom icon has been saved as fragment THEN custom icon should be present in fragment-wizard`, async () => {
        let contentWizard = new ContentWizard();
        let pageComponentView = new PageComponentView();
    ...
    it(`GIVEN existing content with fragment(created from a part) is opened WHEN fragment has been detached THEN part with custom icon should appear in the Page Component View`, async () => {
        let contentWizard = new ContentWizard();
        let pageComponentView = new PageComponentView();
    ...
    it(`GIVEN a part has been selected in PCV WHEN the part has been removed THEN 'Insert panel' should be loaded in Page widget in Context Window`, async () => {
        let contentWizard = new ContentWizard();
        let pageComponentView = new PageComponentView();
        let partInspectionPanel = new PartInspectionPanel();
        ...
        assert.equal(
            ...
            `'Page widget' remains selected after removing a part`,
        );
