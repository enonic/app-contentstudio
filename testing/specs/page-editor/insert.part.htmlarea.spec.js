...
describe('insert.part.htmlarea.spec - insert a html-part in htlmlarea-content', function () {
    ...
    await
    pageComponentView.selectMenuItem(["Duplicate"]);
    ...
    let description1 = await
    pageComponentView.getComponentDescription("Html Area Example", 0);
    assert.equal(description1, PART_DESCRIPTION, "Expected description should be present in the first item");
    let description2 = await
    pageComponentView.getComponentDescription("Html Area Example", 1);
