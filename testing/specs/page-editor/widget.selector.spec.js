...
describe('widget.selector.spec: tests for widget selector', function () {
    ...
    it(`GIVEN wizard for new site is opened WHEN page controller has been selected THEN 'Components' menu item appears in WidgetSelector dropdown`,
        async () => {
            ...
            // 4. Verify that 'Components' option is not present before selecting a controller:
