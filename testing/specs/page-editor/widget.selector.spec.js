...
describe('widget.selector.spec: tests for options in the widget selector', function () {
    ...
    it(`GIVEN wizard for new site is opened WHEN page controller has been selected THEN 'Page' option item should be displayed in WidgetSelector dropdown`,
        async () => {
            ...
            assert.ok(actualOptions1.includes(appConst.WIDGET_SELECTOR_OPTIONS.PAGE) === true, "'Page' option should be displayed in the dropdown list");
            ...
            assert.ok(actualOptions2.includes(appConst.WIDGET_SELECTOR_OPTIONS.PAGE), "'Page' option should be displayed in the dropdown list");
        });
