...
describe('text.component.image.caption.spec: Inserts a text component with an image and checks the caption', function () {
    ...
    it(`WHEN image with caption has been inserted in text component THEN the caption should be present in Page Editor`, async () => {
    ...
    it(`GIVEN text component is inserted WHEN insert image dialog has been opened THEN Upload button should be present in the modal dialog`, async () => {
        let pageComponentView = new PageComponentView();
        let contentWizard = new ContentWizard();
        let textComponentInspectionPanel = new TextComponentInspectionPanel();
        let insertImageDialog = new InsertImageDialog();
    ...
    it(`GIVEN an image has been inserted in text-component WHEN the component has been saved as fragment THEN image element should be with correct src-attribute`, async () => {
        let contentWizard = new ContentWizard();
        let textComponentInspectionPanel = new TextComponentInspectionPanel();
        let pageComponentView = new PageComponentView();
        let insertImageDialog = new InsertImageDialog();
