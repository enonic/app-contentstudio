...
describe('Text Component with CKE - insert content-link specification', function () {
    ...
    it(`GIVEN Text component is inserted AND 'Insert Link' dialog is opened WHEN 'content-link' has been inserted THEN expected data should be present in the CKE`, async () => {
    ...
    it(`GIVEN site is selected WHEN 'Automatic' is selected AND 'Preview' button has been pressed THEN content-link should be present in the page`, async () => {
