...
describe('wizard.setting.panel.spec:  test for Owner and Language selectors', function () {
    ...
    it(`WHEN folder-wizard is opened WHEN a language has been selected THEN the same language should be present in the Wizard Details Panel`, async () => {
        let contentWizard = new ContentWizard();
    ...
    it(`WHEN a language has been updated THEN the updated language should be displayed in browse details panel`, async () => {
        let detailsWidgetInfoSection = new DetailsWidgetInfoSection();
    ...
    it(`WHEN folder-wizard is opened WHEN the default owner has been removed THEN owner property gets not visible in the property widget`, async () => {
        let contentWizard = new ContentWizard();
        let detailsWidgetInfoSection = new DetailsWidgetInfoSection();
