...
describe('insert.image.dlg.apply.custom.style.spec: apply a custom style to an image', function () {
    ...
    insertImageDialog.getStyleSelectorOptions();
    ...
    await
    insertImageDialog.doFilterStyleAndClickOnOption("Cinema");
    //5. Verify that 'Custom Width' checkbox is enabled
    await
    insertImageDialog.waitForCustomWidthCheckBoxEnabled();
    ...
    let actualStyle = await
    insertImageDialog.getSelectedStyleName();
