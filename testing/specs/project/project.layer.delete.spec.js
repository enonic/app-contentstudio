...
describe('project.layer.delete.spec - ui-tests for deleting a layer', function () {
    ...
    it("GIVEN new layer has been created WHEN the layer has been reopened THEN 'Copy Access mode' button is enabled", async () => {
    ...
    it('GIVEN new layer is created WHEN the layer has been deleted in the wizard THEN layer should not be present in the grid', async () => {
        let settingsBrowsePanel = new SettingsBrowsePanel();
    ...
    it("GIVEN layer was deleted in the previous step WHEN the parent project is opened THEN 'Delete' button gets enabled in the wizard-toolbar", async () => {
        let settingsBrowsePanel = new SettingsBrowsePanel();
    ...
    // Verifies https://github.com/enonic/app-contentstudio/issues/2105
    // Do not allow deletion of a project if it has child layer.
    it("GIVEN layer was deleted WHEN the parent project has been selected THEN 'Delete' button gets enabled now", async () => {
        let settingsBrowsePanel = new SettingsBrowsePanel();
