/**
 * Created on 09.09.2020. updated on 27.08.2026
 */
...
describe('layers.content.tree.dialog.spec - tests for Layers Content Tree modal dialog', function () {
    ...
    it('Preconditions: new project with folder should be added', async () => {
    ...
    it('Precondition 1 - the first layer(En) should be added in Default project', async () => {
    ...
    it("WHEN layer, that has child layer, have been selected THEN 'Delete' button should be disabled", async () => {
        let settingsBrowsePanel = new SettingsBrowsePanel();
    ...
    it('WHEN children layers have been sequentially removed THEN parent project can be deleted', async () => {
        let settingsBrowsePanel = new SettingsBrowsePanel();
