...
class ContentBrowsePanel extends BaseBrowsePanel {
    ...
    async clickOnUnpublishButton() {
        try {
            ...
            throw new Error(`Error occurred in Browse Panel toolbar - Unpublish button screenshot: ${screenshot} ` + err);
        }
    }
    ...
    async clickOnMoveButton() {
        try {
            ...
            await this.saveScreenshotUniqueName("err_move");
            throw new Error('Error occurred after clicking on Move button ' + err);
        }
    }
    ...
    async clickOnPreviewButton() {
        try {
            ...
            throw new Error(`Error occurred after clicking on Preview button, screenshot:${screnshot} ` + err);
        }
    }
    ...
    async clickOnCheckboxAndSelectRowByName(name) {
        try {
            ...
            throw new Error(`Error occurred during clicking on the checkbox, screenshot: ${screenshot}` + err);
        }
    }
