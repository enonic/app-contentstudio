...
const xpath = {
    ...
    previewNotAvailableSpan: "//div[contains(@class,'no-preview-message')]//span[text()='Preview not available']",
    ...
    previewToolbarMenuItems: "//div[contains(@id,'PreviewToolbar') and @role='menu']//div[@role='menuitemradio']/p/span[1]",
};
...
class ContentItemPreviewPanel extends Page {
    ...
    get previewButton() {
        return xpath.toolbar + "//button[contains(@aria-label, 'Open in new tab')]";
    }
    ...
    async waitForPreviewButtonEnabled() {
        try {
            ...
            await this.handleError(`'Preview' button should be enabled `, 'err_preview_btn', 'err_preview_btn', err);
        }
    }
