...
const xpath = {
    widget: "//div[contains(@id,'ContentWizardPanel')]//div[contains(@id,'LayersExtensionItemView')]",
    widgetItemView: "//div[contains(@id,'ContentWizardPanel')]//div[contains(@id,'LayersExtensionItemView')]",
};
