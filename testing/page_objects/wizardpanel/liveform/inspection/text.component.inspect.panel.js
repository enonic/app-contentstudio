...
class TextComponentInspectionPanel extends BaseComponentInspectionPanel {
    ...
    async clickInTextArea() {
        try {
            await this.waitForElementDisplayed(this.textArea);
            await this.clickOnElement(this.textArea);
            await this.pause(100);
        } catch (err) {
            await this.handleError(
                'Inspect Panel, Text Component - tried to click in text area: ',
                'err_click_text_area',
                err,
            );
        }
    ...
    async clickOnInsertLinkButton() {
        ...
        try {
            ...
            await this.handleError(
                'Inspect Panel, Text Component - tried to click on Insert Link button: ',
                'err_insert_link_button',
                err,
            );
        }
    }
    ...
    async clickOnInsertTableButton() {
        try {
            await this.waitForElementDisplayed(this.insertTableButton);
            await this.clickOnElement(this.insertTableButton);
            return await this.pause(300);
        } catch (err) {
            await this.handleError(
                'Inspect Panel, Text Component - tried to click on Insert Table button: ',
                'err_insert_table_btn',
                err,
            );
        }
    }
    ...
    async waitForTableDisplayedInEditorFrame() {
        await this.waitForElementDisplayed("//iframe[contains(@class,'text')]");
    ...
    async clickOnInsertImageButton() {
        try {
            ...
            await this.handleError(
                'Inspect Panel, Text Component - tried to click on Insert Image button ',
                'err_insert_image_btn',
                err,
            );
        }
    }
    ...
    async clickOnSourceButton() {
        try {
            await this.waitForElementDisplayed(this.sourceButton);
            await this.clickOnElement(this.sourceButton);
        } catch (err) {
            await this.handleError(
                'Inspect Panel, Text Component - tried to click on Source button: ',
                'err_insert_link_button',
                err,
            );
        }
    ...
    async clickOnPasteModeButtonButton() {
        try {
            await this.waitForElementDisplayed(this.pasteModeButton);
            await this.clickOnElement(this.pasteModeButton);
        } catch (err) {
            await this.handleError(
                'Inspect Panel, Text Component - tried to click on Paste Mode button: ',
                'err_paste_mode_btn',
                err,
            );
        }
    ...
    async clickOnInsertMacroButton() {
        try {
            await this.waitForElementDisplayed(this.insertMacroButton);
            await this.clickOnElement(this.insertMacroButton);
        } catch (err) {
            await this.handleError(
                'Inspect Panel, Text Component - tried to click on Insert Macro button: ',
                'err_insert_macro_btn',
                err,
            );
        }
    }
