...
class LiveFormPanel extends Page {
    ...
    async verifyImageElementsInComponent(index) {
        let elements11 = await this.findElements("//div[@id='mainRegion']");
        let elements1 = await this.findElements("//div[contains(@id,'FragmentComponentView')]");
