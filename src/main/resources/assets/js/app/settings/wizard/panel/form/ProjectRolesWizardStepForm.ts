...
export class ProjectRolesWizardStepForm extends ProjectWizardStepForm {
    ...
    disable() {
        this.accessCombobox.getComboBox().setEnabled(false);
        this.accessCombobox.addClass('disabled');
        this.accessCombobox.getSelectedOptionView().getSelectedOptions().forEach(
            (o: SelectedOption<ProjectAccessControlEntry>) => o.getOptionView().setEditable(false));
    }
